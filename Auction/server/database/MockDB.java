...
public class MockDB {
    ...
    static {
        userTable.put("BD000001", new common.models.Person.Bidder("BD000001","Adam", "123456", 10000));
        userTable.put("BD000002", new common.models.Person.Bidder("BD000002","Eva", "123456", 10000));
        userTable.put("BD000003", new common.models.Person.Seller("BD000003","Zeus", "123456", 10000));

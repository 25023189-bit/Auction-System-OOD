...
public class AuthViewModel {
    ...
    public String getForgotConfirmPassword() { return forgotConfirmPassword; }
    public void setForgotConfirmPassword(String forgotConfirmPassword) { this.forgotConfirmPassword = forgotConfirmPassword; }
}

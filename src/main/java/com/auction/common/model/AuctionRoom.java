...
public class AuctionRoom implements Serializable {
    ...
    public void setAuctionId(String auctionId) { this.roomId = auctionId; }

    public String getItemId() { return itemId; }
    public void setItemId(String itemId) { this.itemId = itemId; }

    public String getProductId() { return itemId; }
    public void setProductId(String productId) { this.itemId = productId; }
    ...
    public LocalDateTime getActualEndTime() { return endTime; }
